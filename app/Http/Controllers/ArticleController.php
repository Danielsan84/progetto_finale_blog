...
class ArticleController extends Controller
{
    ...
    {
        $request->validate([
            'title' => 'required|unique:articles|min:15', //lunghezza minima 5 caratteri e deve essere unico
            'subtitle' => 'required|unique:articles|min:25',//lunghezza minima 5 caratteri e deve essere unico
            'body' => 'required|min:100', //lunghezza minima 10 caratteri 
