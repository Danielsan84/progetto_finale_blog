...
// rotta pubblica per la home 
Route::get('/', [PublicController::class, 'home'])->name('home');
// rotta pubblica per la pagina careers
Route::get('/careers', [PublicController::class, 'careers'])->name('careers');
// rotta pubblica per la pagina careers submit
Route::post('/careers/submit', [PublicController::class, 'careersSubmit'])->name('careers.submit');
// rotta per il swicthcolor
Route::get('/switchcolor', [PublicController::class, 'switchColor'])->name('switchcolor');
...
// rotte per la gestione dei revisori
...
// rotte per la gestione degli scrittori
Route::middleware('writer')->group(function(){
    ...
    //rotta per la gestione del profilo utente 
