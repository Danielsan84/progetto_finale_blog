//script for the switch button on the navbar to change the theme of the page from light to dark and vice versa with the help of the local storage of the browser to save the theme of the page when the user refreshes the page or closes the browser and opens it again later on.
//the function to change the theme of the page
